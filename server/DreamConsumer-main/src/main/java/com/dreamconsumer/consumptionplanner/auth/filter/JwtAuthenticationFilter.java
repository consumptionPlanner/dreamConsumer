package com.dreamconsumer.consumptionplanner.auth.filter;
...
import com.dreamconsumer.consumptionplanner.member.dto.MemberLoginDto;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) {
        ...
        MemberLoginDto memberLoginDto = objectMapper.readValue(request.getInputStream(), MemberLoginDto.class); // inputStream을 Dto로 역직렬화
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        Member member = (Member) authResult.getPrincipal(); // AuthenticationManager 내부 인증 성공 -> 인증된 Authentication 객체 생성
