    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .antMatchers(HttpMethod.DELETE,"/users/{user-id}").hasRole("USER") // 회원 탈퇴
                        .antMatchers(HttpMethod.PATCH, "/activate/{user-id}").hasRole("USER") // 휴면 계정 해제
                        .antMatchers(HttpMethod.GET,"/users/{user-id}").hasRole("USER")
